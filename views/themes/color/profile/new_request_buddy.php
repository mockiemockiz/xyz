...
<div class="pp_req">
    <img src="http://localhost/sillaturrahim/thumb_profile.php?img=<?php echo $b['pp']; ?>&w=80&h=100" />
</div>
    <div style="margin-left:18px; float:left;">
        ...
        <button type="button" onclick="callAJAX();" style="float:left; margin-left:10px;">
