<div id="top">
	...
	<div id="menu_top2">
  <ul id="menu_top">
    <li onclick="wall();" class="link"> <img src="views/themes/default/icons/wall.png" /> Wall </li>
...
<div class="boxes_side">
		...
		<?php if($data['view_as']==$data['uid']): ?>
		<li><a href="#" onclick="open_modal('index.php?page=profile&amp;sub=change_pp',400,185,100);" >Change Profile Picture</a></li>
		<?php endif; ?>
	...
	<div class="boxes_side">
		<h3><?php echo $data['lang'][0][$data['lang2']]; ?> :</h3>
