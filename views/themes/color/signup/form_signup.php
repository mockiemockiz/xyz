	 ...
	 <form method="post" action="?page=signup" id="sign" style="margin-top:10px;">
      <table border="0" cellpadding="10" cellspacing="0">
        <tr>
          ...
          <td>:</td>
          <td><input type="text" name="name" size="25" id="fname" /></td>
        </tr>
        <tr>
        <tr>
          <td width="100px"> Middle Name </td>
          <td>:</td>
          <td><input type="text" name="name" size="25" id="mname" /></td>
        </tr>
		<tr>
          <td width="100px"> Surname </td>
          <td>:</td>
          <td><input type="text" name="name" size="25" id="sname" /></td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="100px"></td>
          <td></td>
          <td><input type="button" value="sign up" class="submit" onclick="postAJAX('?page=signup','dialog_content','sign');" />
