...
<title> Jejaring sosial "XYZ" </title>
...
<div id="tengah">
  <div id="logo">
  <img src="views/themes/default/images/logo.gif" style="margin-left:11px;" />
  ...
  <ul id="myRoundabout">
    <li>
      ...
      <?php echo($data['lang'][0][$data['lang2']]); ?> <br />
    ...
    <li>
      <h3><img src="views/themes/default/icons/advert.png" alt="sign up" /><a href="?page=about_us">About Us</a></h3>
       <?php echo($data['lang'][3][$data['lang2']]); ?>
     <a href="?page=help">
	  <button type="button" style="margin-left:35%; margin-top:10%;">About Us</button>
	  </a>
      </li>
    <li>
	  ...
	  <a href="?page=help">
	  <button type="button" style="margin-left:35%; margin-top:10%;">Help me</button>
	  </a>
	  </li>
  </ul>
  <div id="footer">
