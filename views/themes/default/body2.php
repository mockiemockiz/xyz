...
<div id="tengah2">
<div id="logo">
<img src="views/themes/default/images/little_logo.gif" style="margin-left:10px;" />
<div id="menu">
...
<div style="width:72%; height:auto; padding-bottom:100px; float:left;" id="body">
...
<div class="boxes_side">
		<h3> Your Menu </h3>
		<ul>
		<li><?php echo $data['lang'][7][$data['lang2']]; ?></li>
