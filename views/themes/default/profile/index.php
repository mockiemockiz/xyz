...
function stat(){
rt=$('#wall').load('index.php?page=profile&sub=wall&uid=<?php echo $data['view_as']; ?>');
setTimeout(rt,5000);
}
...
function post_reply(post,el,form){
$('#'+post).fadeOut(1500);
postAJAX('index.php?page=wall&sub=post_reply',el,form);
}
...
<div id="tengah2">
<div id="logo"><div id="the_logo"></div>
<div id="menu">
...
<a href="?page=privacy_policy"><?php echo $data['lang'][18][$data['lang2']]; ?></a> |
	<a href="?page=tos"> <?php echo $data['lang'][19][$data['lang2']]; ?></a> | 
	<a href="?page=copyright"> <?php echo $data['lang'][20][$data['lang2']]; ?> </a>
	</p>
</div>
<div class="clearer"></div>
