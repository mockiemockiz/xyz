<ul class="wall_items">
  ...
  &nbsp;
    ...
    <?php echo(!empty($w['unlikes'])) ? $w['unlikes'] : '0' ; ?> <?php echo $data['lang'][12][$data['lang2']]; ?>   </div>
...
style="float:left; margin-left:10px;">
  ...
  <div id="<?php echo $w['id']; ?>comments_box" style="float:left; width:98%; color:#444; font-size:9px">
     ...
     <!-------------------------------------------- script gui buat reply mulai dari sini ----------------- !-->
  ...
  <a href="?page=wall&sub=show_reply&idw=<?php echo $w['id']; ?>"><?php echo $data['lang'][13][$data['lang2']]; ?> </a>
   </div>
   <?php else: ?>
   <div class="replies_box">
   <div id="<?php echo $w['id']; ?>last_reply"></div>
  ...
  <?php  echo $data['wall_paging']['paging']; 
  endif; ?>